...
//rows totals
$total_t=(array_key_exists('2020',$key)?$key[2020]['t']:0)+(array_key_exists('2021',$key)?$key[2021]['t']:0)+(array_key_exists('2022',$key)?$key[2022]['t']:0);
$total_u=(array_key_exists('2020',$key)?$key[2020]['u']:0)+(array_key_exists('2021',$key)?$key[2021]['u']:0)+(array_key_exists('2022',$key)?$key[2022]['u']:0);
$g_total_t+=$total_t;
$g_total_u+=$total_u;
