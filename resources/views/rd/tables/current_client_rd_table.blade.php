...
//rows totals
$total_t=(array_key_exists('2021',$key)?$key[2021]['t']:0)+(array_key_exists('2022',$key)?$key[2022]['t']:0)+(array_key_exists('2023',$key)?$key[2023]['t']:0)+(array_key_exists('2024',$key)?$key[2024]['t']:0);
