...
//rows totals
$total_t=(array_key_exists('2022',$key)?$key[2022]['t']:0)+(array_key_exists('2023',$key)?$key[2023]['t']:0)+(array_key_exists('2024',$key)?$key[2024]['t']:0)+(array_key_exists('2025',$key)?$key[2025]['t']:0);
$total_u=(array_key_exists('2022',$key)?$key[2022]['u']:0)+(array_key_exists('2023',$key)?$key[2023]['u']:0)+(array_key_exists('2024',$key)?$key[2024]['u']:0)+(array_key_exists('2025',$key)?$key[2025]['u']:0);
$g_total_t+=$total_t;
$g_total_u+=$total_u;
...
// $total_u=(array_key_exists('2021',$key)?$key[2021]['u']:0)+(array_key_exists('2022',$key)?$key[2022]['u']:0)+(array_key_exists('2023',$key)?$key[2023]['u']:0)+(array_key_exists('2024',$key)?$key[2024]['u']:0);
$total_u=(array_key_exists('2022',$key)?$key[2022]['u']:0)+(array_key_exists('2023',$key)?$key[2023]['u']:0)+(array_key_exists('2024',$key)?$key[2024]['u']:0)+(array_key_exists('2025',$key)?$key[2025]['u']:0);
