...
class PricesController extends Controller
{
    ...
    public function list_prices()
    {
        ...
        $price_table=DB::select(DB::raw('SELECT  track_prices.id, track_prices.price_capture_date, track_prices.order_name, track_prices.path_to_attachments ,   track_prices.price_us , track_prices.price_yuan , track_prices.price_eur,     track_prices.offer_type ,    track_prices.us_yuan_at_date, track_prices.eur_yuan_at_date, track_prices.eur_us_at_date,     products.model ,track_prices.packing,track_prices.packingqty,track_prices.comments, products.country ,products.maker FROM track_prices join products on track_prices.product=products.id WHERE track_prices.is_active=1;'));
        //dd($price_table);
